...
class Product {
  ...
  static List<Product> featured = [
    Product(
      ...
      numberOfSold: 3,
      description: 'Hub type C USB C10 /C8/C6/C5/C4 JVJ cổng chuyển đổi chia cổng Type-C sang các loại cổng USB 3.0 SD, TF, 4K HDMI (TÙY CÁC MÃ Hub tương ứng SHOP có sẵn) cho MacBook laptop - Bảo hành 2 năm chính hãng',
    ),
    Product(
      ['37', '38', '39'],
  ...
  static List<Product> products = [
    ...
    Product(
      ...
      image: "https://firebasestorage.googleapis.com/v0/b/nfo-app.appspot.com/o/products%2F3.png?alt=media",
      numberOfSold: 2,
      description: 'Nhấn theo dõi Shop để cập nhật các thông tin mới nhất về sản phẩm và khuyến mại.'
    ...
    Product(
      ...
      numberOfSold: 3,
      description: '- Tận dụng tối đa các mã miễn phí vận chuyển, mã giảm giá của Shopee và mã giảm giá của Shop. '
    ...
    Product(
      ...
      numberOfSold: 5,
      description: '+ Chấp nhận đổi hàng trong các trường hợp hàng bị lỗi, không đúng mẫu, không vừa size '
    ...
    Product(
      ...
      numberOfSold: 2,
      description: '- Nên vệ sinh giày vào ban ngày hạn chế vệ sinh giày vào buổi tối'
